id = 1    # id number for each proof step
map = {}  # map from id number to its corresponding proof step
...
def imply_i(pDEDUCEq):
  ...
  print(getID(), pDEDUCEq.__name__.replace("DEDUCE", " -> "), '      ->i rule')
  return pIMPLYq
